# Getting started to perform full backup with gpbackup and gprestore
...
# Tips:
1. How to find the backup Timestamp
```
 gpbackup -dbname tutorial | grep "Backup Timestamp" | sed 's/.*Backup Timestamp = *//'
```
# Reference:
